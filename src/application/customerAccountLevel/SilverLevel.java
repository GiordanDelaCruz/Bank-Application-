...
public class SilverLevel implements LevelState{
	...
	double onlinePurchaseFee = 20.00;
	 ...
	 */
	public SilverLevel(BankAccount newBankAccount) {
	...
	/**
	 * This method will perform a online purchase for a silver level bank account
	 * 
	 * @param priceOfItem
	 * 
